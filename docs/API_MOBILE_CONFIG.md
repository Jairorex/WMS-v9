...
const API_BASE_URL = __DEV__
  ? Platform.OS === 'android'
    ...
    : 'http://localhost:8000/api'  // Emulador iOS
  : 'http://192.168.1.100:8000/api'; // Tu IP local para dispositivo físico
...
- [ ] Configurar URL de API según entorno (emulador/dispositivo)
- [ ] Implementar manejo de formato de respuesta estandarizado
- [ ] Implementar manejo de errores (401, 403, 500)
...
- [ ] Verificar que CORS permite origen móvil
...
**✅ La API está lista para desarrollo móvil con formato estandarizado y estructura de datos documentada.**
