# 📦 Paquete de Instalación WMS Escasan

## 🎯 Descripción del Paquete

Este paquete contiene todo lo necesario para instalar el **Sistema WMS Escasan** en una nueva PC, incluyendo:

- ✅ **Backend Laravel** completo
- ✅ **Frontend React** completo  
- ✅ **Base de datos SQL Server** con todos los módulos
...
│   ├── 📄 instalar_modulos.sql    # Instalar módulos
│   ├── 📄 datos_iniciales.sql     # Datos de prueba
│   └── 📄 verificar_instalacion.sql # Verificar instalación
├── 📁 scripts/                    # Scripts de instalación
│   ├── 📄 instalar_windows.bat    # Instalación automática Windows
